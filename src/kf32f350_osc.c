...
/**
  ...
  *                     SCLK_SOURCE_PLL2: 选择PLL2输出作为系统时钟,
  *                     SCLK_SOURCE_PLL1: 选择PLL1输出作为系统时钟,
  * 返回  无。
  */
void
...
/**
  ...
  *                      CK48M_SOURCE_PLL2: 选择PLL2输出作为CK48M输入时钟,
  *                      CK48M_SOURCE_PLL1: 选择PLL1输出作为CK48M输入时钟,
  * 返回  无。
  */
void
...
/**
  ...
  *                PLLmultiple_M 0X04-0X3FFF范围(要大于等于4)
  *                PLLmultiple_N 0X01-0XF范围
